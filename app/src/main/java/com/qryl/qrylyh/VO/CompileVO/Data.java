...
public class Data {
    ...
    public int getGoodAppraiseNum() {
        return goodAppraiseNum;
    }

    public void setGoodAppraiseNum(int goodAppraiseNum) {
    ...
    public String getPublishCarer() {
        return publishCarer;
    }

    public void setPublishCarer(String publishCarer) {
        this.publishCarer = publishCarer;
    }
