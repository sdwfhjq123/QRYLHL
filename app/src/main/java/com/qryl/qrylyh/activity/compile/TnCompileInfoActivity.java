...
public class TnCompileInfoActivity extends BaseActivity {
        ...
        try {
            ...
            if (resultCode.equals("200")) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        //显示
                        Glide.with(TnCompileInfoActivity.this).load(ConstantValue.URL + headshotImg).thumbnail(0.1f).into(civHead);
    ...
    private void clickItemShowDialog() {
        ...
        realName.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                View view = View.inflate(TnCompileInfoActivity.this, R.layout.text_item_dialog_text, null);
                ...
                new MyAlertDialog(TnCompileInfoActivity.this, view)
                        //.setView(view)
        ...
        identity.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                View view = View.inflate(TnCompileInfoActivity.this, R.layout.text_item_dialog_num, null);
                TextView tvTitileDialog = (TextView) view.findViewById(R.id.tv_title_dialog);
                final EditText etHintDialog = (EditText) view.findViewById(R.id.et_hint_dialog);
        ...
        gender.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DialogUtil.showMultiItemsDialog(TnCompileInfoActivity.this, "选择性别", R.array.gender, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
        ...
        workExperience.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DialogUtil.showMultiItemsDialog(TnCompileInfoActivity.this, "选择工作经验", R.array.work_experience, new DialogInterface.OnClickListener() {
        ...
        beGoodAtWork.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TnCompileInfoActivity.this, BeGoodAtWorkActivity.class);
        ...
        hospital.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TnCompileInfoActivity.this, HospitalActivity.class);
        ...
        location.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TnCompileInfoActivity.this, LocationActivity.class);
        ...
        office.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TnCompileInfoActivity.this, OfficeActivity.class);
    ...
    private void putExtra() {
        Intent intent = new Intent(TnCompileInfoActivity.this, HsCompilePicActivity.class);
        //传递数据
    ...
    private void showPopupWindow() {
        ...
        btnPopCamera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                popupWindow.dismiss();
                if (ContextCompat.checkSelfPermission(TnCompileInfoActivity.this, android.Manifest.permission.CAMERA) !=
                        PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(TnCompileInfoActivity.this, new String[]{android.Manifest.permission.CAMERA}, 1);
                } else {
                    //打开相机
                    openCarema();
                }
    ...
    private void openCarema() {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            imageUri = FileProvider.getUriForFile(TnCompileInfoActivity.this, "com.qryl.qrylhl.fileprovider", outputImage);
        } else {
    ...
    private void invokeAlbum() {
        //动态申请危险时权限，运行时权限
        if (ContextCompat.checkSelfPermission(TnCompileInfoActivity.this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE) !=
                PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(TnCompileInfoActivity.this, new String[]{android.Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
        } else {
            openAlbum();
        }
    }
        ...
        switch (requestCode) {
            case 1:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(TnCompileInfoActivity.this, "you denied the permission", Toast.LENGTH_SHORT).show();
                }
                break;
            default:
                break;
    ...
    private void handleImageOnKitKat(Intent data) {
        ...
        Uri uri = data.getData();
        //Log.i("uri", uri + "");
        if (DocumentsContract.isDocumentUri(TnCompileInfoActivity.this, uri)) {
    ...
    private void displayImage(String imagePath) {
        if (imagePath != null) {
            ...
            Toast.makeText(TnCompileInfoActivity.this, "failed to get image ", Toast.LENGTH_SHORT).show();
        }
    }
