...
public class YsCompleteInfoActivity extends AppCompatActivity {
    ...
    private void clickItemShowDialog() {
        ...
        realName.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                View view = View.inflate(YsCompleteInfoActivity.this, R.layout.text_item_dialog, null);
        ...
        gender.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DialogUtil.showMultiItemsDialog(YsCompleteInfoActivity.this, "选择性别", R.array.gender, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
        ...
        hospital.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(YsCompleteInfoActivity.this, HospitalActivity.class));
            }
        });
        //我所在的科室
        office.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(YsCompleteInfoActivity.this, OfficeActivity.class));
            }
        });
        //擅长的工作
    ...
    private void nextiFNotNull() {
        if (bitmap == null) {
            Toast.makeText(YsCompleteInfoActivity.this, "您还未设置头像", Toast.LENGTH_SHORT).show();
            return;
        }
        if (tvName.equals("未填写")) {
            Toast.makeText(YsCompleteInfoActivity.this, "您还未填写姓名", Toast.LENGTH_SHORT).show();
            return;
        }
        if (tvIdentity.equals("未填写")) {
            Toast.makeText(YsCompleteInfoActivity.this, "您还未填写身份证", Toast.LENGTH_SHORT).show();
            return;
        }
        if (tvGender.equals("男") || tvGender.equals("女")) {
            Toast.makeText(YsCompleteInfoActivity.this, "您还未设置性别", Toast.LENGTH_SHORT).show();
            return;
        }
        if (tvAge.equals("请选择")) {
            Toast.makeText(YsCompleteInfoActivity.this, "您还未填写性别", Toast.LENGTH_SHORT).show();
            return;
        }
...
//        }
    ...
    private void openCarema() {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            imageUri = FileProvider.getUriForFile(YsCompleteInfoActivity.this, "com.qryl.qrylyh.activity.login.complete.fileprovider", outputImage);
        } else {
        ...
        switch (requestCode) {
            case 1:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(YsCompleteInfoActivity.this, "you denied the permission", Toast.LENGTH_SHORT).show();
                }
                break;
            default:
                break;
    ...
    private void handleImageOnKitKat(Intent data) {
        ...
        Uri uri = data.getData();
        //Log.i("uri", uri + "");
        if (DocumentsContract.isDocumentUri(YsCompleteInfoActivity.this, uri)) {
    ...
    private void displayImage(String imagePath) {
        if (imagePath != null) {
            ...
            Toast.makeText(YsCompleteInfoActivity.this, "failed to get image ", Toast.LENGTH_SHORT).show();
        }
    }
