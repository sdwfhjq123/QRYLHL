...
public class HsCompileInfoActivity extends BaseActivity {
    ...
    private void showPopupWindow() {
        ...
        btnPopCamera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                popupWindow.dismiss();
                if (ContextCompat.checkSelfPermission(HsCompileInfoActivity.this, android.Manifest.permission.CAMERA) !=
                        PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(HsCompileInfoActivity.this, new String[]{android.Manifest.permission.CAMERA}, 1);
                } else {
                    //打开相机
                    openCarema();
                }
    ...
    private void openCarema() {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            imageUri = FileProvider.getUriForFile(HsCompileInfoActivity.this, "com.qryl.qrylhl.fileprovider", outputImage);
        } else {
