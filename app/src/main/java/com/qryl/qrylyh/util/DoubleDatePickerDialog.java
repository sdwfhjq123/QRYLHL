...
public class DoubleDatePickerDialog extends AlertDialog implements OnClickListener, OnDateChangedListener {
    ...
    public DoubleDatePickerDialog(Context context, int theme, OnDateSetListener callBack, int year, int monthOfYear,
                                  int dayOfMonth) {
        this((FragmentActivity) context, 0, callBack, year, monthOfYear, dayOfMonth, true);
    }
     ...
     * @param dayOfMonth
     */
    public DoubleDatePickerDialog(FragmentActivity context, int theme, OnDateSetListener callBack, int year, int monthOfYear,
